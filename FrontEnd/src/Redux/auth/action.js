...
export const NurseLogin = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:4000/nurses/login",
      data
    );
    dispatch({
...
export const DoctorLogin = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:4000/doctors/login",
      data
    );
...
export const DoctorRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:4000/doctors/register",
      data
    );
    // console.log(res);
    return res.data;
...
export const NurseRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:4000/nurses/register",
      data
    );
    // console.log(res);
    return res.data;
...
export const AmbulanceRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:4000/ambulances/add",
      data
    );
    console.log(res);
    // dispatch({
